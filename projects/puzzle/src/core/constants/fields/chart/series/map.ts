...
export const CHART_MAP_SERIES: EditorChartField = {
  label: '数据系列配置',
  key: 'seriesGroup',
  schemaType: 'group',
  children: [
    {
      ...
      removeActive: true,
      children: [
        { label: '类型', key: 'type', path: 'type', schemaType: 'select', disabled: true, options: [{ label: '地图', val: 'map' }] },
        { label: '系列名称', key: 'name', path: 'name', schemaType: 'text' },
        { label: '地图名称', key: 'map', path: 'map', schemaType: 'text' },
        {
          label: '数据项名称映射',
          key: 'encodeItemName',
