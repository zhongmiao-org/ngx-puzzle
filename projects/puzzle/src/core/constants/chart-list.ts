...
export const CHART_SERIES_TYPE_OPTIONS: BaseSelectOption<ChartTypesEnum>[] = [
	...
	{ label: '形状地图', val: ChartTypesEnum.mapShape, notRender: true },
	{ label: '线地图', val: ChartTypesEnum.mapLine, notRender: true },
	// todo 先不渲染,这个后面完善
	{ label: '标记地图', val: ChartTypesEnum.mapMarker, notRender: true},
	{ label: '背景形状地图', val: ChartTypesEnum.mapShapeBackground, notRender: true },
	{ label: '背景线地图', val: ChartTypesEnum.mapLineBackground, notRender: true },
];
