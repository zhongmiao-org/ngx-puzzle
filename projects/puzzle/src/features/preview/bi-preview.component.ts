...
import { ComponentConfig, ComponentInjectorService, ComponentRegistryService, previewType, SessionIndexedDbService,ZoomScaleService } from '../../core';
import { StylesFormatPipe } from '../../shared/pipes/styles-format.pipe';
import { Debounce } from '../../shared';
import { isEqual } from 'lodash';

@Component({
	selector: 'imm-bi-preview',
	standalone: true,
	imports: [NgStyle, StylesFormatPipe],
	templateUrl: './bi-preview.component.html',
	styleUrl: './bi-preview.component.scss',
})
export class BiPreviewComponent implements AfterViewInit, OnDestroy {
