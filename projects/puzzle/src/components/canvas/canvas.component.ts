...
import { ComponentConfig, Size, Tick, TooltipPosition } from 'ngx-puzzle/core/interfaces';
import { ComponentInjectorService } from 'ngx-puzzle/core/mediator/component-inject.service';
