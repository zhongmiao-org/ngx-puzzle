...
// 	template: ``,
// })
// export abstract class CanvasBaseComponent<TConfigProps extends ComponentBaseProps = ComponentBaseProps, TSubType = string>
...
//
// 	protected readonly localeText = AG_GRID_LOCALE_CN;
//
